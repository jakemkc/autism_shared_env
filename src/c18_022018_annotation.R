...
load("results/c18Scale_plots.Rdata") 
# hilic_hmdb <- read.csv(file = "data/c18_stage5_DBmatches_HMDB.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
# hilic_kegg<- read.csv(file = "data/c18_stage5_DBmatches_KEGG.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
# hilic_lipid<- read.csv(file = "data/c18_stage5_DBmatches_LipidMaps.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
#     # MELTIN no batch d/l, leave it first

hilic_hmdb <- read.csv(file = "data/c18_new_Stage4_HMDB_c18neg.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
hilic_kegg<- read.csv(file = "data/c18_new_Stage4_KEGG_c18neg.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
hilic_lipid<- read.csv(file = "data/c18_new_Stage4_LipidMaps_c18neg.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
...
tmp3 <- rbind(fdrsign_hmdb_unique, fdrsign_kegg_unique, fdrsign_lipid_unique) # 12 obs mz
