...
load("results/c18_ewas_sign_corr.Rdata") 
...
outfilename <- sprintf("heatmapAsd_mother_ASDIntra_%s.pdf", saveName)
quartz.save(file.path(outdirectory,outfilename), type = "pdf", device = dev.cur(), dpi = 300)


## parents
heatmap.2(cor_motherIntra,
...
# save
outdirectory <- "./results"
outfilename <- sprintf("heatmapMother_intra_%s.pdf", saveName)
quartz.save(file.path(outdirectory,outfilename), type = "pdf", device = dev.cur(), dpi = 300)

## family
heatmap.2(cor_mother,
...
# save
outdirectory <- "./results"
outfilename <- sprintf("heatmapMother_family_%s.pdf", saveName)
quartz.save(file.path(outdirectory,outfilename), type = "pdf", device = dev.cur(), dpi = 300)
...
# save
outdirectory <- "./results"
outfilename <- sprintf("heatmapAsd_father_ASDIntra_%s.pdf", saveName)
quartz.save(file.path(outdirectory,outfilename), type = "pdf", device = dev.cur(), dpi = 300)


## parents
heatmap.2(cor_fatherIntra,
          main = "Parent correlation",
          trace = "none", 
          margins = c(5,5), 
          col = heatmapColors(4), 
...
# save
outdirectory <- "./results"
outfilename <- sprintf("heatmapFather_intra_%s.pdf", saveName)
quartz.save(file.path(outdirectory,outfilename), type = "pdf", device = dev.cur(), dpi = 300)

## family
heatmap.2(cor_father,
          main = "Family correlation",
          trace = "none", 
          margins = c(5,5), 
          col = heatmapColors(4), 
...
# save
outdirectory <- "./results"
outfilename <- sprintf("heatmapFather_family_%s.pdf", saveName)
quartz.save(file.path(outdirectory,outfilename), type = "pdf", device = dev.cur(), dpi = 300)
...
outdirectory <- "./results"
outfilename <- sprintf("clusterSign_motherCaseIntra%s.png", saveName)
...
## save
outdirectory <- "./results"
outfilename <- sprintf("chemOrder_motherCaseIntra_%s.rds", saveName)
...
outdirectory <- "./results"
outfilename <- sprintf("clusterSign_fatherCaseIntra%s.png", saveName)
dev.copy(png, filename=file.path(outdirectory,outfilename), width=1024, height=768)
dev.off()
