...
data_original <- read.csv(file = "data/c18_ComBat_mzcalibrated_untargeted_averaged_featuretable.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
data_pheno <- read.csv(file = "data/c18_pheno.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE)
