...
hilic_hmdb <- read.csv(file = "data/c18_new_Stage5_HMDB_neg.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
hilic_kegg<- read.csv(file = "data/c18_new_Stage5_KEGG_neg.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
hilic_lipid<- read.csv(file = "data/c18_new_Stage5_LM_neg.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
